...
local region-level image descriptors are extracted
on a spatial grid and a similarity score is computed between
the audio embedding and each of the vision descriptors
