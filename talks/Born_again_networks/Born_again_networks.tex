...
\caption{DNN acoustic models used in Automatic Speech Recognition. Distilled model trained by an ensemble of experts performs better than the baseline. \cite{cit:distill}}
\end{figure}
